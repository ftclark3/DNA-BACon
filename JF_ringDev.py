...
# ------------------------------------------------------------------------------
#jon's special bs
funal_struct = final_struct.copy()
transform.translate_structure(funal_struct, 0, 20, 0)
final_struct = final_struct.merge(funal_struct, copy_props=True)
final_struct.write("bobsring.mae")
exit()
#-------------------------------------------------------------------------------
# bind walls together
